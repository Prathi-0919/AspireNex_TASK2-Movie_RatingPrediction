...
1. Movie&Ratings_data: Contains movie information after preprocessing, including MovieName, Genre, actors , directors and MovieIDs, ratings information after preprocessing, 
   including Ratings and Timestamp.
2. Users_data: Contains user information after preprocessing, including Gender, Age, Occupation, and Zip-code.
